...
install :; forge install openzeppelin/openzeppelin-contracts@v5.0.2 --no-commit && forge install dmfxyz/murky --no-commit && forge install cyfrin/foundry-devops@0.2.2 --no-commit && forge install foundry-rs/forge-std@v1.8.2 --no-commit
